...
import { Globe2, Landmark, Plane, Send, Loader2 } from 'lucide-react'
...
const suggestions = [
  ...
  { title: 'Adventure Destination', icon: <Globe2 className='text-yellow-500 h-5 w-5' /> },
]
    ...
    <div className='mt-24 flex justify-center'>
      <div className='max-w-3xl w-full text-center space-y-6'>
        ...
        <div className='border rounded-2xl p-4 relative'>
          ...
          />
          <Button size="icon" className="absolute bottom-6 right-6" onClick={onSend} disabled={loading}>
