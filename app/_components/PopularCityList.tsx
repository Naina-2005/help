...
export function PopularCityList() {
  ...
  return (
    <div className="w-full h-full py-20">
      <h2 className="max-w-3xl pl-4 mx-auto text-xl md:text-5xl font-bold text-neutral-800 dark:text-neutral-200 font-sans">
...
const data = [
  ...
  },
  {
    ...
    src: "https://plus.unsplash.com/premium_photo-1675975678457-d70708bf77cb?q=80&w=1170&auto=format&fit=crop",
    content: <DummyContent />,
  },
  {
    category: "Dubai, UAE",
    title: "Luxury and Innovation - Burj Khalifa, Desert Safari",
    src: "https://images.unsplash.com/photo-1526495124232-a04e18491680?q=80&w=687&auto=format&fit=crop",
    content: <DummyContent />,
  },
  {
    category: "India",
    title: "Heritage & Nature - Taj Mahal, Backwaters, Wildlife",
